...
function Luxt1.CreateWindow(libName, logoId)
    ...
    key1.ZIndex = 2
    key1.Font = Enum.Font.GothamBlack
    key1.Text = "LeftAlt"
    ...
    game:GetService("UserInputService").InputBegan:connect(function(current, ok) 
        if not ok then 
            if current.KeyCode.Name == oldKey then 
                if HugeLib.Enabled == true then
                    HugeLib.Enabled = false
                else
                    HugeLib.Enabled = true
                end
            end
        end
    end)
    ...
    keybindInfo1.Font = Enum.Font.GothamBlack
    ...
    --
    libName = libName or "HugeLib"
    logoId = logoId or ""
    --

    HugeLib.Name = "HugeLib"..libName
    HugeLib.Parent = game.CoreGui
    HugeLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    usename.ZIndex = 2
    usename.Font = Enum.Font.GothamBlack
        ...
        function sectionHandling:Section(sectionText)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    toggleInfo.ZIndex = 2
                    toggleInfo.Font = Enum.Font.GothamBlack
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        keybindInfo.Font = Enum.Font.GothamBlack
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            textboxInfo.Font = Enum.Font.GothamBlack
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                sliderbtn.Font = Enum.Font.GothamBlack
                                sliderbtn.Text = ""
                                ...
                                dragPrecent.Font = Enum.Font.GothamBlack
                                dragPrecent.Text = "0%"
                                ...
                                sliderInfo.ZIndex = 2
                                sliderInfo.Font = Enum.Font.GothamBlack
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    dropdownItem1.Font = Enum.Font.GothamBlack
                                    ...
                                    for i,v in next, list do
                                        ...
                                        optionBtn1.Font = Enum.Font.GothamBlack
                                        optionBtn1.Text = "  "..v
